        ...
        <form action="{{ route('testimonial.update', $testimonial->id) }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-5">
                <div class="form-control col-span-1">
                    ...
                    <textarea name="description" class="textarea textarea-bordered w-full col-span-3 textarea-lg" cols="30"
                        rows="16" required>
                ...
                <div class="col-span-1">
                    <div class="form-control col-span-1 mb-10">
                        ...
                        <input type="text" placeholder="Type here" class="input input-bordered w-96" name="name"
                            required value="{{ $testimonial->name }}" />
                    </div>
                    ...
                    <div class="form-control col-span-1 mb-10">
                        ...
                        <input type="text" placeholder="Type here" class="input input-bordered w-96" name="position"
                            required value="{{ $testimonial->position }}" />
                    </div>
                    ...
                    <div class="form-control col-span-1 mb-10">
                        ...
                        <input type="text" placeholder="Type here" class="input input-bordered w-96" name="photo"
                            value="{{ old('photo', $testimonial->photo) }}" required />
                    </div>
                    ...
                    <div class="flex items-center">
                        <div class="form-control col-span-1 mb-10">
                            ...
                            @if ($testimonial->status == true)
                                <input type="checkbox" name="status" class="checkbox border border-black" checked />
                            @else
                                <input type="checkbox" name="status" class="checkbox border border-black" />
                            @endif
